classdef dstBetaRev < handle & dstC
properties
    dataAlt
end
methods
    function obj=dstBetaRev(data,alpha,beta,support)
        obj.dataAlt=((data-0.5)*-1)+0.5;
        obj.toFit=[1,2];
        ...
        obj.type='Beta';
        obj.pdfFun=@(X,alpha,beta) ((betapdf(X,alpha,beta)-0.5)*-1)+.05;
